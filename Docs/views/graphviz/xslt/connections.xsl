...
<xsl:strip-space elements="host_list"/>
  ...
  kuipernet108 [ color = "white", fontcolor = "lightgrey" ];
  kuipernet109 [ color = "white", fontcolor = "lightgrey" ];
  kuipernet110 [ color = "white", fontcolor = "lightgrey" ];
  kuipernet111 [ color = "white", fontcolor = "lightgrey" ];
</xsl:text>
  ...
  <xsl:template match="host">
	...
	-->
        <xsl:if test="./*[@net='hinet-internal']">
	  <xsl:value-of select="$nice_shortname"/>
	...
	-->
        <xsl:if test="./*[@net='pirlnet-internal']">
	  <xsl:value-of select="$nice_shortname"/>
